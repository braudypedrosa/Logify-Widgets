...
// save fields as JSON
add_filter('acf/settings/save_json', 'vmbpopups_acf_json_save_point');
 
function vmbpopups_acf_json_save_point( $path ) {
...
add_filter('acf/settings/load_json', 'vmbpopups_acf_json_load_point');

function vmbpopups_acf_json_load_point( $paths ) {
    unset($paths[0]);
